...
public class Dijkstra {
	...
	/**
	 * 078 This method applies Dijkstra's algorithm to the graph using the Vertex
	 * 079 specified by initialVertexLabel as the starting point. 080
	 *
	 * 081
	 * 
	 * @post The shortest a-b paths as specified by Dijkstra's algorithm and 082
	 *       their distances are available 083
	 */
	 ...
	 *            The Vertex whose shortest path from the initial Vertex is desired
	 *            126
	 * @return LinkedList<Vertex> A sequence of Vertex objects starting at the 127
	 *         initial Vertex and terminating at the Vertex specified by
	 *         destinationLabel. 128 The path is the shortest path specified by
	 ...
	 * 
	 * @param destinationLabel
	 *            The Vertex to determine the distance from the initial Vertex 146
	 * @return int The distance from the initial Vertex to the Vertex specified by
	 *         destinationLabel 147
	 */
